 ...
 */
public class MezcladoraDeNombres extends javax.swing.JFrame {

    private DialogError dError;
    private JDesktopPane desktopPane;
    
    public MezcladoraDeNombres() {
        initComponents();
        setLocationRelativeTo(this);
        setResizable(false);
        jTextArea1.setEnabled(false);
        jButtonReiniciar.setEnabled(false);
        dError = new DialogError(this, true);
    }
    ...
    private void jButtonMezclarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMezclarActionPerformed
        ...
        // Validación para comprobar si los nombres tienen 4 o más caracteres
        if (nombre1.length() < 4 || nombre2.length() < 4) {
            // Mostrar el JDialog de error si alguno de los nombres tiene menos de 4 caracteres
            ...
            // Salir de este método para evitar continuar
            return;
        }

        // Deshabilitar los campos de texto y el botón de mezclar
        jTextField1Nombre.setEnabled(false);
        jTextField2Nombre.setEnabled(false);
        jButtonMezclar.setEnabled(false);

        // Generar los nombres mezclados (primera mitad del primer nombre con la segunda del segundo y viceversa)
        ...
        // Mostrar los nombres mezclados en el área de texto
        jTextArea1.setText("1. " + mezcla1 + "\n2. " + mezcla2 + "\n3. " + mezcla3 + "\n4. " + mezcla4);
        jTextArea1.setEnabled(true); // Habilitar el área de texto
        jButtonReiniciar.setEnabled(true); // Habilitar el botón reiniciar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MezcladoraDeNombres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MezcladoraDeNombres().setVisible(true);
            }
        });
    }
